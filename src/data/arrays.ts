...
export const coursesAndDurationArray: LightCourseType[] = [
...
export const coursesArray: MiddleCourseType[] = [
    {
...
export const usersList: FullUserType[] = [
    {
        id: 1,
        name: 'Leanne Graham',
        username: 'Bret',
